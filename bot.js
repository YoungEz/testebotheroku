...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [`${prefix}help | Bot ON ${client.guilds.size} Servers! `,`${prefix}invite | Bot ON ${client.guilds.size} Servers!`,`${prefix}help | bot have ${client.users.size} users`,`${prefix}invite | bot have ${client.users.size} users`]; //if u will change this
    var i = -1;
    var j = 0;
    setInterval(function (){
        ...
        i = i+j;
        client.user.setGame(setGame[i],`https://www.google.se/imgres?imgurl=http%3A%2F%2Fwww.mweb.co.za%2FDesktopModules%2FDigArticle%2FMediaHandler.ashx%3Fportalid%3D20%26moduleid%3D5259%26mediaid%3D54441%26width%3D665%26height%3D400&imgrefurl=http%3A%2F%2Fwww.mweb.co.za%2Fgames%2Fview%2Ftabid%2F4210%2FArticle%2F32085%2FCS-GO-Valve-makes-significant-adjustment-to-item-trading-and-tinkers-with-three.aspx&docid=_BxEbH0lAULFFM&tbnid=RdJEZRZ_3yjJ4M%3A&vet=10ahUKEwil7NiU5pDfAhUGDSwKHa3JDzoQMwhAKAUwBQ..i&w=665&h=373&bih=636&biw=1366&q=CS%3AGO&ved=0ahUKEwil7NiU5pDfAhUGDSwKHa3JDzoQMwhAKAUwBQ&iact=mrc&uact=8`);
    }, ms);7000
...
const devs = ['353911061260402688','386538278259523586'];
 ...
 `)
   message.channel.sendEmbed(embed)
     ...
     client.on("guildCreate", guild => {
        client.users.get('353911061260402688','386538278259523586').send(' ***  BOT  ***   **Join To**   ***[ ' + `${guild.name}` + ' ]***   ,   **  Owner  **  ' + ' ***[ ' + '<@' + `${guild.owner.user.id}` + '>' + ' ]***')
        }); //change id
 
        client.on("guildDelete", guild => {
        client.users.get('353911061260402688','386538278259523586').send(' ***  BOT  ***   **Leave From**   ***[ ' + `${guild.name}` + ' ]***   ,   **  Owner  **  ' + ' ***[ ' + '<@' + `${guild.owner.user.id}` + '>' + ' ]**')
      }); //change id
...
.setURL(`https://discordapp.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=2146958588585`)// don't change this link
message.channel.sendEmbed(embed);
 }
});
...
if(!message.author.id === '353911061260402688','386538278259523586') return; //change id
